...
#[cfg(any(feature = "pg11", feature = "pg12", feature = "pg13", feature = "gp7"))]
...
pub unsafe fn register_hook(hook: &'static mut (dyn PgHooks)) {
    ...
    #[cfg(any(feature = "pg11", feature = "pg12", feature = "pg13", feature = "pg14", feature = "pg15", feature = "gp7"))]
...
#[cfg(any(feature = "pg11", feature = "pg12", feature = "gp7"))]
#[pg_guard]
