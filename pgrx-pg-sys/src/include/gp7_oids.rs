...
pub enum BuiltinOid {
    ...
    ANYRANGEOID = 3831,
    ANYTABLEOID = 7053,
    AO_COLUMN_TABLE_AM_HANDLER_OID = 4188,
    AO_COLUMN_TABLE_AM_OID = 3435,
    AO_ROW_TABLE_AM_HANDLER_OID = 4187,
    AO_ROW_TABLE_AM_OID = 3434,
    AccessMethodOperatorRelationId = 2602,
    AccessMethodProcedureRelationId = 2603,
    AccessMethodRelationId = 2601,
    AppendOnlyRelationId = 6105,
    AttributeRelationId = 1249,
    AuthIdRelationId = 1260,
    BITARRAYOID = 1561,
    BITMAP_AM_OID = 7013,
    BITMAP_INDEXAM_HANDLER_OID = 7050,
    BITOID = 1560,
    BOOLARRAYOID = 1000,
    BOOLOID = 16,
    ...
    GP_HYPERLOGLOG_ESTIMATORARRAYOID = 7165,
    GP_HYPERLOGLOG_ESTIMATOROID = 7157,
    GTSVECTORARRAYOID = 3644,
    GTSVECTOROID = 3642,
    GpPolicyRelationId = 7142,
    GpSegmentConfigRelationId = 5036,
    HASH_AM_OID = 405,
    ...
    MACADDROID = 829,
    MEDIAN_FLOAT8_OID = 6127,
    MEDIAN_INTERVAL_OID = 6128,
    MEDIAN_TIMESTAMPTZ_OID = 6130,
    MEDIAN_TIMESTAMP_OID = 6129,
    MONEYARRAYOID = 791,
    NAMEARRAYOID = 1003,
    NAMEOID = 19,
...
impl BuiltinOid {
    pub const fn from_u32(uint: u32) -> Result<BuiltinOid, NotBuiltinOid> {
        match uint {
            ...
            7053 => Ok(BuiltinOid::ANYTABLEOID),
            4188 => Ok(BuiltinOid::AO_COLUMN_TABLE_AM_HANDLER_OID),
            3435 => Ok(BuiltinOid::AO_COLUMN_TABLE_AM_OID),
            4187 => Ok(BuiltinOid::AO_ROW_TABLE_AM_HANDLER_OID),
            3434 => Ok(BuiltinOid::AO_ROW_TABLE_AM_OID),
            ...
            6105 => Ok(BuiltinOid::AppendOnlyRelationId),
            1249 => Ok(BuiltinOid::AttributeRelationId),
            1260 => Ok(BuiltinOid::AuthIdRelationId),
            1561 => Ok(BuiltinOid::BITARRAYOID),
            7013 => Ok(BuiltinOid::BITMAP_AM_OID),
            7050 => Ok(BuiltinOid::BITMAP_INDEXAM_HANDLER_OID),
            ...
            7199 => Ok(BuiltinOid::COMPLEXARRAYOID),
            7198 => Ok(BuiltinOid::COMPLEXOID),
            2147 => Ok(BuiltinOid::COUNT_ANY_OID),
            ...
            7056 => Ok(BuiltinOid::CompressionRelationId),
            ...
            7165 => Ok(BuiltinOid::GP_HYPERLOGLOG_ESTIMATORARRAYOID),
            7157 => Ok(BuiltinOid::GP_HYPERLOGLOG_ESTIMATOROID),
            3644 => Ok(BuiltinOid::GTSVECTORARRAYOID),
            3642 => Ok(BuiltinOid::GTSVECTOROID),
            7142 => Ok(BuiltinOid::GpPolicyRelationId),
            5036 => Ok(BuiltinOid::GpSegmentConfigRelationId),
            ...
            6127 => Ok(BuiltinOid::MEDIAN_FLOAT8_OID),
            6128 => Ok(BuiltinOid::MEDIAN_INTERVAL_OID),
            6130 => Ok(BuiltinOid::MEDIAN_TIMESTAMPTZ_OID),
            6129 => Ok(BuiltinOid::MEDIAN_TIMESTAMP_OID),
            ...
            9107 => Ok(BuiltinOid::PublicationRelationId),
